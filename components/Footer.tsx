      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Let's Connect</h3>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Feel free to reach out for collaborations or a chat.</p>
          </div>
          <div className="flex space-x-6">
            ...
            <a href={SOCIAL_LINKS.email} className="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors duration-300">
